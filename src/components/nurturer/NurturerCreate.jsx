...
const NurturerCreate = () => {
    const { addNurturer } = useContext(NurturerContext);
    const [newNurturer, setNewNurturer] = useState({
        image: "",
        fullName: "",
        dateOfBirth: "",
        gender: "",
    ...
    return (
        <>
            ...
            <Form onSubmit={handleSubmit(onSubmit)} className="form" id="nurturerCreate">
                <Form.Group className="mb-3 form-group">
                    <Form.Control
